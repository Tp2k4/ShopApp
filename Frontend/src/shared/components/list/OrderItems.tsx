    ...
    <div className="flex flex-col gap-[var(--small-gap)]" {...rest}>
        ...
        <div className="gap-[var(--medium-gap)] w-full flex items-center justify-between">
            <div className="flex  items-center gap-[var(--medium-gap)]">
              <div className="w-[80px] h-[80px] bg-[var(--primary-color)] rounded-sm"></div>  {/* ảnh sản phẩm */}
              <div className="flex flex-col"> {/* thông tin sản phẩm */}
            ...
            <div className="flex flex-col gap-[var(--medium-gap)]">
              <div className="flex gap-[var(--small-gap)]"> 
                <div className="line-through text-[var(--original-price-color)]">400000đ</div> {/* giá gốc */}
                <div className="text-[var(--discounted-price-color)]">500000đ</div> {/* giá đã giảm */}
              </div>
              <div className="flex justify-end"><Button text="Mua lại" type="button" width="w-auto"/></div>  {/* nút mua lại */}
            </div>
        </div>
