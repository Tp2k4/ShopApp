  ...
  return (
    <div className="items-center justify-start min-w-[200px] h-auto flex flex-col bg-white p-[var(--semi-medium-gap)] rounded-md border-[var(--line-color)] border shadow-sm hover:shadow-md transition-all duration-200 ease-in-out">
      <div className=" flex flex-col items-start justify-start h-auto gap-[var(--small-gap)]">
        ...
        <div className="flex flex-wrap items-center justify-start bg-[var(--background-color)] rounded-md  w-full gap-[var(--small-gap)] p-[var(--small-gap)]">
          <div className="flex justify-center items-center gap-[var(--smallest-gap)]">
            <Icon
              name="BiBluetooth"
              size="12px"
              className="opacity-[var(--caption-opacity)]"
            />
            <div className=" opacity-[var(--caption-opacity)] caption">
              wireless
            </div>
          </div>
          <div className="flex justify-center items-center gap-[var(--smallest-gap)]">
